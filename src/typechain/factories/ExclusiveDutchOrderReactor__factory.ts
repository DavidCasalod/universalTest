...
import type {
  ...
  ExclusiveDutchOrderReactorInterface,
} from "../ExclusiveDutchOrderReactor";
...
export class ExclusiveDutchOrderReactor__factory {
  static readonly abi = _abi;
  static createInterface(): ExclusiveDutchOrderReactorInterface {
    return new Interface(_abi) as ExclusiveDutchOrderReactorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ExclusiveDutchOrderReactor;
  }
}
